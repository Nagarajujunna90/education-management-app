...
@Service
public class TeacherPesonalInfoServiceImpl implements TeacherPesonalInfoService {

    @Autowired
    TeacherPersonalInfoRepository teacherPersonalInfoRepository;
    private AuthServiceClient authServiceClient;

    public TeacherPesonalInfoServiceImpl(AuthServiceClient authServiceClient) {
